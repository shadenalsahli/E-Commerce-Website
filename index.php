            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="team-card mb-5">
                        <img class="img-fluid" src="website_images/admin.jpg" alt="">
                        <div class="team-desc">
                            <h4 class="mb-0">
                            <button class="hovBtn" type="submit" name="adminPage">Admin Page</button>
                            </h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="team-card mb-5">
                        ...
                        <div class="team-desc">
                            <h4 class="mb-0">
                                <button class="hovBtn" type="submit" name="Customer">Customer Page</button>
                            </h4>
                        </div>
                    </div>
                </div>
